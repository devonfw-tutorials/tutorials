...
[step]
--
executeCommand("mvn archetype:generate ", "mvn archetype:generate", {"args":["-DarchetypeVersion=3.0.1", "-DarchetypeGroupId=com.devonfw.java.templates", "-DarchetypeArtifactId=devon4j-template-server", "-DgroupId=com.example.application", "-DartifactId=sampleapp", "-Dversion=1.0.0-SNAPSHOT", "-Dpackage=com.devonfw.application.sampleapp", "-DinteractiveMode=false", "-DarchetypeVersion=2020.08.001"] })
--
