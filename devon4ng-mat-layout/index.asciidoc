...
[step]
--
changeFile("main/devon4ng-mat-layout/src/styles.scss", { "file": "files/styles.txt" })
--
...
[step]
--
changeFile("main/devon4ng-mat-layout/src/app/app.component.html", { "file": "files/app.component.txt" })
--